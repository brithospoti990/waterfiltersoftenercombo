...
<footer class="site-foot">
  <div class="foot-inner">
    <div>
      <h4>WaterFilterSoftenerCombo.com</h4>
      <p>Independent, owner-tested guidance on whole-house water filter and softener combo systems. We test in a real home on real Arizona hard water — not from a spec sheet.</p>
    </div>
    <div>
      <h4>Contact</h4>
      <address>
...
def build():
    ...
    for slug, meta in PAGES.items():
        ...
        if depth_prefix:
            body = body.replace('src="/author-kelly.svg"', f'src="{depth_prefix}author-kelly.svg"')
        page = (
            HEAD.format(
